...
- **Everything rarer lives behind a quiet ⋮ menu** (The Quiet Surface Rule) with the same actions the player carries for the playing track: Listen on Spotify and Similar tracks, plus the row's own (a finding with footage offers its story). No platform mark trails the row; Spotify is one tap away in the menu.
