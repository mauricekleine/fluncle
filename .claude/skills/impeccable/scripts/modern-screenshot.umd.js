(function (y, v) {
  ...
  var Oe = Math.pow,
    Le = (y, v, N) =>
      v in y ? rr(y, v, { configurable: !0, enumerable: !0, value: N, writable: !0 }) : (y[v] = N),
    D = (y, v) => {
      for (var N in v || (v = {})) {
...
`);
  ...
  function Ot(e, t) {
    if ($(e)) {
      ...
      if (!re(r)) {
        return [
          z(t, { imageDom: e, requestType: "image", responseType: "dataUrl", url: r }).then((n) => {
              ...
              Array.from(f.cssRules).map((h) =>
                C(this, null, function* () {
                  if (Je(h)) {
                    ...
                    let p = "";
                    try {
                      p = yield z(t, { requestType: "text", responseType: "text", url: g });
                    } catch (b) {
