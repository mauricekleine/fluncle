...
- **Log IDs** are the finding's coordinate: the lowercase scheme `fluncle://241.7.3A`, shown bare as `241.7.3A` in tight columns. Set in Oxanium tabular like every other number (the Tabular Rule). Opaque on purpose — a coordinate, not a row number.
...
| Where                    | Today                                                    | Becomes                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------ | -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Meta description         | "Fresh drum & bass transmissions from Fluncle's Finest." | The canonical entity description, verbatim: "Drum & bass bangers from another dimension. Fluncle digs and certifies every track, logs each as a finding, and keeps the full archive across the Galaxy, from the web to the rave terminal. fluncle.com is home base." One string for every surface that describes the entity (JSON-LD, llms.txt, the glossary, bios); it opens with the tagline. A trimmed ≤155-char variant (`fluncleMetaDescription`) carries the `<meta>`/OG/Twitter SERP snippet, because search engines flag and truncate the full one: "Drum & bass bangers from another dimension. Fluncle digs, certifies, and logs every find, with the full archive across the Galaxy at fluncle.com." |
