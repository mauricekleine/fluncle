...
- **`app.ios`** — the classic external-approval case, dark pending App Store review; its flip swaps the placeholder search URL for the assigned listing URL.
