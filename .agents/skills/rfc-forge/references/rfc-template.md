...
- **Completeness ≠ no sequencing.** Separate PRs and an ordered critical path are how a *complete* delivery ships safely. The standard forbids cutting achievable work, not staging it.
