...
1. **Read/examine the work** in full before judging
2. **Listen for ugliness first** — it's easier to see ugliness than imagine beauty. What makes you flinch?
3. **Run each principle** as a lens. Not all 14 apply to every work — focus on the ones that reveal something
4. **Prioritize** — which principles, if addressed, would most transform the quality?
5. **Suggest specific changes** — taste without the ability to gratify it is incomplete
