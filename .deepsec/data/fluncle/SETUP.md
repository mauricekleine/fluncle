# Agent setup for `fluncle`

This is a deepsec scanning workspace. Project `fluncle` was just registered
(target: `..`). Setup is incomplete — `data/fluncle/INFO.md`
...
2. **Fill in `data/fluncle/INFO.md`.** It's auto-injected into the AI
