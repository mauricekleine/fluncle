...
- [LORE.md](./LORE.md) - the story canon: the narrative loop every surface draws from (a banger is an experience, the video relives it, the crew shares it, the star is a waypoint, the mixtape is a dream, the letter is what he sends back), the Galaxy, and the crew. Wins on story; the other three canons defer to it there.
