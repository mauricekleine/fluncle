...
const PUBLIC_UNAUTH_OPS = new Set<string>([
  ...
  "deregister_device",
  "register_device",
  "subscribe_follow_digest",
  "submit_track",
  "subscribe_newsletter",
  "unsubscribe_follow_digest",
...
const EXPECTED_TIERS: Record<string, "admin" | "operator" | "private-session"> = {
  ...
  delete_private_follow: "private-session",
  ...
  list_private_follows: "private-session",
  ...
  revoke_private_follow_link_access: "private-session",
  save_private_finding: "private-session",
  save_private_follow: "private-session",
  ...
  set_follow_digest_state: "operator",
