...
const CROP_W = 608;
const MAX_X = VIDEO_WIDTH - CROP_W;
...
describe("crop geometry", () => {
  ...
  it("centres the 9:16 window as the default framing", () => {
    ...
    expect(centredCropLeftFraction(400, 1080)).toBe(0);
  });
