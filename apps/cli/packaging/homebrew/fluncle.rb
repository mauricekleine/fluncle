...
class Fluncle < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "REPLACE_WITH_SHA256_OF_fluncle-darwin-arm64"
    end
    on_intel do
      url "https://github.com/mauricekleine/fluncle/releases/download/v#{version}/fluncle-darwin-x64"
      sha256 "REPLACE_WITH_SHA256_OF_fluncle-darwin-x64"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "REPLACE_WITH_SHA256_OF_fluncle-linux-arm64"
    end
    on_intel do
      url "https://github.com/mauricekleine/fluncle/releases/download/v#{version}/fluncle-linux-x64"
      sha256 "REPLACE_WITH_SHA256_OF_fluncle-linux-x64"
    end
  end
