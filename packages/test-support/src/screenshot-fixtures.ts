...
export const SCREENSHOT_ARTISTS: readonly ScreenshotArtist[] = [
  ...
  { name: "Sable Lung", slug: "sable-lung" },
...
export const SCREENSHOT_FINDINGS: readonly ScreenshotFinding[] = [
  ...
  },
  {
    ...
    key: "D minor",
    logId: "803.3.0C",
    note: "The drums are doing something unkind to the downbeat and I am here for it.",
    slug: "neon-undertow",
    title: "Neon Undertow",
  },
  {
    ...
    key: "C major",
    logId: "804.4.0D",
    note: "Warmest thing in the sector. Sounds like a tape that has been played too often.",
    slug: "saltglass",
    title: "Saltglass",
  },
  {
  ...
  },
  {
    ...
    key: "B minor",
    logId: "807.7.0G",
    note: "Comes up like a sunrise you did not plan to be awake for.",
