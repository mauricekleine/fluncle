...
// (`GLSL.filmGrain` is a tool, not a mandate). Each track composition authors its
// OWN scene code, importing only what is exported here. The creative doctrine —
// vehicles, texture families, type staging — lives in the fluncle-video skill, not
// in this code.
//
