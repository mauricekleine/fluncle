...
| Change the voice                                                               | `docs/agents/hermes/SOUL.md` (and/or the `copywriting-fluncle` skill it delegates to)                           | redeploy SOUL.md / the skill to the box + restart, then re-run the voice gate. |
