...
3. **box.ascii — nothing to ship.** Pre-1.0, self-updating, unpinnable. The routine never bumps it; the pin-watch post-smoke re-verifies the conductor after any rebuild it does. A sweep mentions it only as a one-line "unpinnable, re-verify post-rebuild" note.
