...
// bucket) — the whole song rather than a 30s preview (RFC docs/full-audio-rfc.md § Unit 2).
//
...
// RFC docs/full-audio-rfc.md § Unit 2. Everything downstream is source-agnostic.
...
// local `--audio-file` path share ONE decoder (RFC docs/full-audio-rfc.md § Unit 2).
...
if (import.meta.main) {
  ...
  if (audioFile) {
    // Full-song path (RFC docs/full-audio-rfc.md § Unit 2): the enrich sweep S3-GETs
