...
5. **Read the music's arc (doctrine 10).** The energy curve and the drop are the clip's shape — read them (the key timestamps go in your header comment) and let the one vehicle evolve continuously with them: density, structure, palette lean, exposure, and framing rising, easing back, and cresting where the music does, building to the one climax.
