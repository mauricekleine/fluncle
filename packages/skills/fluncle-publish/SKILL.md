...
| **YouTube Shorts** (live)           | `footage.mp4`        | ✓ title + description | ✓ custom thumbnail (`cover.jpg`) | ✓ the video's own audio                                                                                                          | **Direct public upload** (Data API v3) on the push — title/description/thumbnail carry. Content ID may _claim_ the clip (rights holder monetizes, we don't) — accepted; the goal is reach. |
