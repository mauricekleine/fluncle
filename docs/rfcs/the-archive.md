...
- **[D7] The operator hand-curates the seed labels.** The crawler seeds ONLY from a list he ticks — the single highest-leverage input to catalogue quality. ~8 of the 39 labels in the archive arrived via crossover remixes and are not DnB (Anjunabeats, Armada, Axtone, Positiva, Tomorrowland Music, Atlantic Records UK, Counter Records, Zerothree). The curated list is a build input; do not seed from the raw label column.
