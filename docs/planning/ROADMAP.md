...
- [ ] **Store submission tail (operator):** the 6.9" screenshot set, paste the kit into App Store Connect, submit for review — the softened scrim, the latest JS, and the Decks set builder (the listing's 4.2 lead) all ride the submission build.
