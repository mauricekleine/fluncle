...
function buildAuthoringPrompt(finding: Finding, contextNote: string): string {
  ...
  return [
    ...
    "  - ONE short line, roughly 24 to 220 characters (well under the 280 cap). One or two sentences.",
    "  - Lead with the body — the sound, the feel — then, if there is room, the turn to the crew.",
