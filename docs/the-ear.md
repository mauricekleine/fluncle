...
| `catalogue_rank_corpus`    | the corpus fingerprint the values above were computed against, `"<logic-version>:<findings>:<embedded>:<qualified-artists>"`. Staleness. |
