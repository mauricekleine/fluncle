...
The grammar split in one line: grain everywhere, one Eclipse Gold sun moment, Oxanium for brand marks and numerals, warm darks, the close card are LAW; palette blend, texture family (nebula / analog / dither / paint), motion energy, and scene composition are YOURS.
...
3. **Concept.** Choose a texture family and write yourself a two-sentence scene concept matched to the song's energy curve (a liquid roller wants drift and nebula; a neuro stomper wants dither, glitch, and hard onset flashes). Decide where the one Eclipse Gold sun moment lands.
